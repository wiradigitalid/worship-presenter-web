...
Direction: Operator controls → LC-14 → LC-10 → projector. Slideshow is a separate projected page; it does not join LC-10 and must not ack. LC-9 from the controls. Plan from LC-16 (Hub). Does not write Registry. AD-16 snapshot-read is omitted until the table ships (OQ-28).
