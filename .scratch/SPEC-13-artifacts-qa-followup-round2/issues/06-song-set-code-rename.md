...
- [ ] Closes `BUG-15`'s reopened sub-item: SPEC-12 ticket 07 claimed this as done; round-2 QA
...
- [ ] Follows the `[Rename] | Canvas: [Reset] [Save]`-style grouping `DEC-011` already established
      elsewhere in this editor, scoped to the code field.
- [ ] **Verified data-safety gap (found in this SPEC's `wdi-review`, edge-case-hunter lens):**
...
- [ ] A test proves the Rename control is present and functional (PATCHes the code field, handles
