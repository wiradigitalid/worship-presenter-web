 ...
 */
/** One finished slide the worker draws. Fade defaults to true. */
...
function collectImageRefs(plan: DrawPlanItem[]): string[] {
 ...
 */
async function embedPlanImages(plan: DrawPlanItem[]): Promise<EmbeddedImages> {
