...
Opening and closing of Bible Talk, opening and closing of Divine Service. Slot identity belongs to the system (glossary), not to a positional `song1` field. Each hymn is one title slide plus N lyric slides; refrain repeats after each verse.
