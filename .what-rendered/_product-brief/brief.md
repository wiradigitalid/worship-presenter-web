...
| OQ-13 | Accessibility floor is out of v1 scope; the canvas editor stays pointer-first with no keyboard equivalent. | A later NFR or owner decision needs a story the current corpus does not promise. **Narrowed 2026-09-08 by DEC-012 (status: draft, pending owner accept): a Delete/Backspace exception is admitted for the canvas; every other keyboard equivalent stays out of scope.** |  | 2026-08-19 | agent |
